  ...
  FileTree = (function() {
    ...
    FileTree.prototype.showTree = function(el, dir, finishCallback) {
      ...
      if (typeof options.script === 'function') {
		...
		result+="<li class='directory collapsed' onclick=\"highLight(this)\"><a rel='abc/'>abc</a></li>";
		result+="<li class='directory collapsed' onclick=\"highLight(this)\"><a rel='def/'>def</a></li>";
		result+="</ul>";
		handleResult(result);
        /*return $.ajax({
          url: options.script,
